...
-- ---------- 单点菜单 ----------
INSERT INTO menu_item (category, name, price, unit, sort) VALUES
  ('cold', '锦绣三文鱼刺身', 298, NULL, 1),
  ('cold', '35年宝丰陈酿醉六月黄', 298, '6只', 2),
  ('cold', '招牌脆皮乳鸽', 68, '只', 3),
  ('cold', '陈派酒香罗氏虾', 108, NULL, 4),
  ('cold', '丘比椒辣八爪鱼', 78, NULL, 5),
  ('cold', '酒香自制牛腱', 78, NULL, 6),
  ('cold', '柠香去骨鸭掌', 68, NULL, 7),
  ('cold', '葱香脆皮鸡', 68, NULL, 8),
  ('cold', '樟树港辣椒捞腰片', 58, NULL, 9),
  ('cold', '老虎菜拌海蜇丝', 38, NULL, 10),
  ('cold', '金瓜慕斯糕', 39, NULL, 11),
  ('cold', '洛神花泡椒莴笋', 32, NULL, 12),
  ('cold', '夜香花拌绣球菌', 32, NULL, 13),
  ('cold', '虫草花拌龙须芽', 29, NULL, 14),
  ('cold', '荆芥拌青瓜', 29, NULL, 15),
  ('cold', '米醋七彩云南花生', 26, NULL, 16),
  ('cold', '油炸花生米', 19, NULL, 17),
  ('hot', '章丘大葱烧金沙参', 398, NULL, 1),
  ('hot', '家烧东海大黄鱼', 298, NULL, 2),
  ('hot', '铁棍山药烧东海鳗鱼肚', 298, NULL, 3),
  ('hot', '沙律芥味大虾球', 128, NULL, 4),
  ('hot', '川湘海鲜一品烩', 128, NULL, 5),
  ('hot', '陈派奶汤扒广肚', 108, NULL, 6),
  ('hot', '避风塘罗氏虾', 108, NULL, 7),
  ('hot', '风味椒盐罗氏虾', 108, NULL, 8),
  ('hot', '国宴红焖羊排', 108, NULL, 9),
  ('hot', '砂锅茄汁安格斯牛肋条', 98, NULL, 10),
  ('hot', '芸豆焖走山鸡', 98, NULL, 11),
  ('hot', '红胡椒猪尾', 88, NULL, 12),
  ('hot', '烟笋炒湖南腊肉', 68, NULL, 13),
  ('hot', '蜜椒松板肉', 68, NULL, 14),
  ('hot', '湖南小炒护心肉', 59, NULL, 15),
  ('hot', '刀板香洋水豆腐', 39, NULL, 16),
  ('hot', '浓汤玛咖菌', 38, NULL, 17),
  ('hot', '金瓜榴莲蜜薯', 36, NULL, 18),
  ('hot', '芦笋百合素什锦', 39, NULL, 19),
  ('hot', '生炒广东西兰花苔', 36, NULL, 20),
  ('hot', '西芹百合炒腰果', 39, NULL, 21),
  ('hot', '油淋广东菜心', 29, NULL, 22),
  ('staple', '特色酱肉包', 39, NULL, 1),
  ('staple', '农家摊咸食', 29, NULL, 2),
  ('staple', '什锦小菜蟒', 39, NULL, 3),
  ('staple', '冰网鲜虾大锅贴', 48, NULL, 4),
  ('staple', '葱香芝麻叶手工面', 12, '碗', 5),
  ('staple', '广式靓汤', 39, NULL, 6),
  ('deposit', '古法豉汁蒸东星斑', 798, '条', 1),
  ('deposit', '古法豉汁蒸老虎斑', 298, '条', 2),
  ('deposit', '古法豉汁蒸多宝鱼', 158, '条', 3),
  ('deposit', '古法豉汁蒸鲈鱼', 98, '条', 4),
  ('deposit', '波士顿龙虾', 598, '斤', 5),
  ('deposit', '白芍基尾虾', 88, '斤', 6),
  ('deposit', '避风塘焗松叶蟹', 988, '只', 7),
  ('deposit', '手打肉饼松叶蟹', 988, '只', 8),
  ('deposit', '新疆红枣烧河鳗', 298, '份', 9),
  ('deposit', '咸肉烧野生甲鱼', 368, '份', 10),
  ('deposit', '罗氏大虾烧牛蛙', 198, '份', 11),
  ('deposit', '江南烹汁八爪鱼', 128, '份', 12),
  ('deposit', '鲜虾羊肚菌素什锦', 158, '份', 13);
